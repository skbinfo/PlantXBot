...
class SchemaManager:
    ...
    'columns': [
        ...
        {'name': 'Sample', 'sqlite_type': 'TEXT', 'semantic_type': 'sample_id', 'description': 'Identifier for the sample from which the isomiR was sequenced.'},
        {'name': 'Isomir_Type', 'sqlite_type': 'TEXT', 'semantic_type': 'category', 'description': 'The type of isomiR (e.g., canonical, 5p trimmed, 3p extended).'},
        {'name': 'Sequence', 'sqlite_type': 'TEXT', 'semantic_type': 'biological_sequence', 'description': 'The nucleotide sequence of the isomiR.'},
        {'name': 'RPM', 'sqlite_type': 'TEXT', 'semantic_type': 'expression_value', 'description': 'Reads Per Million mapped reads, indicating the expression level.'},
        {'name': 'Valid', 'sqlite_type': 'TEXT', 'semantic_type': 'flag', 'description': 'A flag indicating the validation status of the isomiR.'},
        {'name': 'Name', 'sqlite_type': 'TEXT', 'semantic_type': 'name', 'description': 'The official name of the isomiR or its parent miRNA.'},
        {'name': 'Alias', 'sqlite_type': 'TEXT', 'semantic_type': 'alias', 'description': 'Alternative names or aliases for the isomiR.'},
        {'name': 'Parent', 'sqlite_type': 'TEXT', 'semantic_type': 'parent_identifier', 'description': 'Identifier of the parent miRNA from which the isomiR is derived.'},
        {'name': 'Family', 'sqlite_type': 'TEXT', 'semantic_type': 'category', 'description': 'The miRNA family to which the isomiR belongs.'},
        {'name': 'Variant', 'sqlite_type': 'TEXT', 'semantic_type': 'variant_type', 'description': 'Description of the variation type (e.g., SNP, trimming, addition).'},
        {'name': 'Cigar', 'sqlite_type': 'TEXT', 'semantic_type': 'alignment_string', 'description': 'CIGAR string representing the alignment of the isomiR sequence to a reference.'},
        {'name': 'Chr', 'sqlite_type': 'TEXT', 'semantic_type': 'chromosome', 'description': 'The chromosome on which the isomiR is located.'},
        {'name': 'Start', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_position', 'description': 'The starting genomic coordinate of the isomiR.'},
        {'name': 'End', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_position', 'description': 'The ending genomic coordinate of the isomiR.'},
        {'name': 'Strand', 'sqlite_type': 'TEXT', 'semantic_type': 'strand', 'description': 'The genomic strand (+ for forward, - for reverse).'},
        {'name': 'Repeat OverlapHairpin_ID', 'sqlite_type': 'TEXT', 'semantic_type': 'identifier', 'description': 'Identifier for the hairpin precursor, potentially indicating repeat overlap.'},
        {'name': 'Hairpin_Location', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_location', 'description': 'Genomic location of the precursor hairpin sequence.'},
        {'name': 'IsomiR Position within Hairpin', 'sqlite_type': 'TEXT', 'semantic_type': 'position', 'description': 'The start and end position of the isomiR within its precursor hairpin.'},
        {'name': "3’ Non-templated addition", 'sqlite_type': 'TEXT', 'semantic_type': 'sequence_feature', 'description': 'Nucleotides added to the 3-prime end of the isomiR that are not encoded in the genome.'},
        {'name': 'MatureMeta', 'sqlite_type': 'TEXT', 'semantic_type': 'metadata', 'description': 'Metadata related to the mature miRNA sequence.'},
        {'name': 'MatureMeta_Offset', 'sqlite_type': 'TEXT', 'semantic_type': 'offset_value', 'description': 'Positional offset relative to the canonical mature miRNA sequence.'},
        {'name': 'Type', 'sqlite_type': 'TEXT', 'semantic_type': 'category', 'description': 'A general category or classification for the entry.'},
        {'name': 'Hits', 'sqlite_type': 'TEXT', 'semantic_type': 'count', 'description': 'The number of times the sequence was mapped to the genome.'},
        {'name': 'Genomic', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_context', 'description': 'Information about the genomic context of the isomiR.'},
        {'name': 'Gff_Expression', 'sqlite_type': 'TEXT', 'semantic_type': 'expression_data', 'description': 'Expression data derived from GFF (General Feature Format) annotations.'},
        {'name': 'RepeatMaskerClassIsland', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_feature', 'description': 'Annotation from RepeatMasker, indicating overlap with repetitive elements or CpG islands.'},
        {'name': 'Mature_Meta_Data', 'sqlite_type': 'TEXT', 'semantic_type': 'metadata', 'description': 'Additional metadata associated with the mature miRNA.'},
        {'name': 'Validation', 'sqlite_type': 'TEXT', 'semantic_type': 'validation_status', 'description': 'Details regarding experimental validation of the isomiR or its targets.'},
        {'name': 'Tissues', 'sqlite_type': 'TEXT', 'semantic_type': 'tissue_type', 'description': 'Tissues in which the isomiR has been observed.'},
        {'name': 'Stage', 'sqlite_type': 'TEXT', 'semantic_type': 'developmental_stage', 'description': 'Developmental stage associated with the sample.'},
        {'name': 'Conditions', 'sqlite_type': 'TEXT', 'semantic_type': 'experimental_condition', 'description': 'Experimental conditions under which the sample was collected.'},
        {'name': 'Genotype', 'sqlite_type': 'TEXT', 'semantic_type': 'genotype_information', 'description': 'Genotype of the organism from which the sample was derived.'},
        {'name': 'IsomiR sequence', 'sqlite_type': 'TEXT', 'semantic_type': 'biological_sequence', 'description': 'The nucleotide sequence of the isomiR.'},
        {'name': 'SNP id(s)', 'sqlite_type': 'TEXT', 'semantic_type': 'snp_identifier', 'description': 'Identifier(s) for Single Nucleotide Polymorphisms within the isomiR sequence.'},
        {'name': 'Hairpin(s)', 'sqlite_type': 'TEXT', 'semantic_type': 'biological_sequence', 'description': 'The precursor hairpin sequence(s).'},
        {'name': 'Reference sequence(s)', 'sqlite_type': 'TEXT', 'semantic_type': 'biological_sequence', 'description': 'The reference sequence(s) used for alignment.'},
        {'name': 'Reference sequence license plate(s)', 'sqlite_type': 'TEXT', 'semantic_type': 'identifier', 'description': 'Unique identifiers for the reference sequences.'},
        {'name': 'Target_Acc.', 'sqlite_type': 'TEXT', 'semantic_type': 'accession_number', 'description': 'Accession number of the validated or predicted target gene.'},
        {'name': 'Expectation', 'sqlite_type': 'TEXT', 'semantic_type': 'statistical_value', 'description': 'The expectation value (E-value) for the target prediction score.'},
        {'name': 'UPE', 'sqlite_type': 'TEXT', 'semantic_type': 'score', 'description': 'Unpaired Energy (UPE) score for miRNA-target interaction.'},
        {'name': 'miRNA_start', 'sqlite_type': 'TEXT', 'semantic_type': 'position', 'description': 'Start position of the miRNA in the miRNA-target alignment.'},
        {'name': 'miRNA_end', 'sqlite_type': 'TEXT', 'semantic_type': 'position', 'description': 'End position of the miRNA in the miRNA-target alignment.'},
        {'name': 'Target_start', 'sqlite_type': 'TEXT', 'semantic_type': 'position', 'description': 'Start position on the target sequence in the miRNA-target alignment.'},
        {'name': 'Target_end', 'sqlite_type': 'TEXT', 'semantic_type': 'position', 'description': 'End position on the target sequence in the miRNA-target alignment.'},
        {'name': 'miRNA_aligned_fragment', 'sqlite_type': 'TEXT', 'semantic_type': 'aligned_sequence', 'description': 'The aligned portion of the miRNA sequence.'},
        {'name': 'Target_aligned_fragment', 'sqlite_type': 'TEXT', 'semantic_type': 'aligned_sequence', 'description': 'The aligned portion of the target sequence.'},
        {'name': 'Inhibition', 'sqlite_type': 'TEXT', 'semantic_type': 'category', 'description': 'The observed type of inhibition (e.g., cleavage, translational repression).'},
        {'name': 'Target_Desc.', 'sqlite_type': 'TEXT', 'semantic_type': 'description', 'description': 'Description of the target gene or transcript.'}
    ],
    'description': 'IsomiR data for Arabidopsis thaliana, focusing on miRNA variants, their expression, genomic context, and target interactions.',
    ...
    'notes': ["Specific to Arabidopsis thaliana. The RPM column, despite being TEXT type, contains numerical expression values."]
                   },
                }
            }
        }
...
- **RNA Interactions:** Interactions between RNAs (e.g., miRNA-lncRNA, miRNA-mRNA) predicted by tools like RNAhybrid or IntaRNA.
...
INTENT_CLASSIFICATION_PROMPT_TEMPLATE = PromptTemplate(
    ...
    template="""
*** You are a specialized chatbot for answering queries related to isomiRs, that are distinct miRNA isoforms catering to AthisoMir Database***
...
SQL_PLAN_PROMPT_TEMPLATE = PromptTemplate(
    ...
    template="""
You are an AI assistant designed to analyze user queries and plan data retrieval or information provision for AthisoMir Database. Your task is to generate precise, SQLite-compatible SQL queries or metadata responses based on the provided database schemas and knowledge graph.

*** You are a specialized chatbot for answering queries related to isomiRs, that are distinct miRNA isoforms catering to AthisoMir Database, catering to the databases specified in the  database_table_mapping_info`. ***
...
**Instructions:**
- For `DATA_RETRIEVAL` or `METADATA_SQL_FALLBACK_PREFERRED` intents, generate one or more SQLite-compatible SQL queries targeting the relevant tables (`athisomir`, `anninter2`, `linc_data`, `PtRNAdb`).
- Use only the column names provided in `schemas_json` (e.g., 'Isomir_ID', 'Sequence', 'RPM' for athisomir). Do NOT use table names (e.g., 'athisomir') as column names.
...
- **AthisoMir Database (athisomir):** Contains Arabidopsis thaliana miRNA/isomiR data. Key columns include: `Isomir_ID`, `Sequence`, `Isomir_Type`, `RPM`, `Parent`, `Name`, `Chr`, `Start`, `End`.
  - Notes: Arabidopsis-specific (no species column). Use `RPM` for expression.


**CRITICAL DATABASE-SPECIFIC RULES & DATA SEMANTICS:**
- **Cross-Database Joins:**
  - `athisomir` and `anninter2`: Join on `athisomir.Sequence` = `anninter2.interactor1_seq` or `interactor2_seq`.
  - `anninter2` and `linc_data`: Join on `interactor1_seq` or `interactor2_seq` = `linc_data.Sequence`.
- **Species and Tissue Handling:**
  - Species: `linc_data` has a `Species` column. `PtRNAdb` has a `Plant Source` column. For `athisomir` and `anninter2`, assume Arabidopsis thaliana.
  - Tissue: Only `linc_data` has a `Tissue` column.
- **Numeric Columns Stored as TEXT:** In `anninter2` and `PtRNAdb`, score columns are TEXT. Use `CAST` for numeric operations (e.g., `WHERE CAST("p_value" AS REAL) < 0.05`, `WHERE CAST("Infernal Score" AS REAL) > 50`).
- **Expression Data:** Use `athisomir.RPM` (INTEGER) for expression queries. No expression data in other tables.
...
- **Identifier Columns:** Use `Isomir_ID` (athisomir), `pair_id` (anninter2), `AlnC_ID` (linc_data), `PtRNAdb ID` (PtRNAdb) for entity lookups.
...
2. **Database Targeting Strategy:**
   - **Default Grouping:**
     - "miRNA" or "isomiR" -> `athisomir`.
     - "RNA interaction" -> `anninter2`.
     - "lncRNA" -> `linc_data`.
     - "tRNA" or "transfer RNA" -> `PtRNAdb`.
   - **Species Handling:** For `linc_data`, use `Species`. For `PtRNAdb`, use `Plant Source`. For others, assume Arabidopsis thaliana.
...
3. **Response Strategy & SQL Planning:**
   ...
   - **DATA_RETRIEVAL:**
     ...
     - **Simple Listings (e.g., "List tRNAs in rice"):**
       ...
       - `sql`: `SELECT "PtRNAdb ID", "tRNA ID", "Isoacceptor" FROM "PtRNAdb" WHERE "Plant Source" LIKE '%Oryza sativa%' LIMIT {DISPLAY_ROW_LIMIT};`.
     - **Entity Lookups (e.g., "Details for tRNA ID X"):**
       - `purpose_type`: `entity_lookup_detail`.
       - `sql`: `SELECT * FROM "PtRNAdb" WHERE "tRNA ID" = 'X';`.
     - **Aggregations (e.g., "Count tRNA genes in rice"):**
...
# ... (rest of the file from line 1735 to 1775 is unchanged) ...
def process_query(query: str, conversation_id: Optional[str] = None, model_name: str = 'gpt-oss-120b', user_api_key: Optional[str] = None) -> Dict:
    ...
    intent_llm = ChatGroq(
        api_key=user_api_key,
        model_name="openai/gpt-oss-120b", # Reverted to the faster model
        temperature=0.0, 
        max_tokens=500
    )
...
- **Categories for Common Item Checks:**
  ...
  - "tissue": table has no tissue data 

More database info: "ath-isomiRdb is an Arabidopsis thaliana miRNA expression database curated from raw miRNA-seq datasets sourced from the NCBI Sequence Read Archive. A comprehensive set of 2,757 samples has been uniformly analyzed using the IsoMiRmap tool, incorporating Arabidopsis thaliana miRNA data from miRBase (release 22.1)."
"""
