...
class SchemaManager:
        ...
        self.schema = {
            'trf.db': {
                'tables': {
                    'PtRFdb': {
                        'columns': [
                            {'name': 'ptrf_id', 'sqlite_type': 'TEXT', 'semantic_type': 'primary_identifier', 'description': 'Unique tRF ID.'},
                            {'name': 'organism', 'sqlite_type': 'TEXT', 'semantic_type': 'organism_name', 'description': 'Species name.'},
                            {'name': 'trf_type', 'sqlite_type': 'TEXT', 'semantic_type': 'category', 'description': 'Type of tRF (e.g., tRF-5).'},
                            {'name': 'tissue', 'sqlite_type': 'TEXT', 'semantic_type': 'tissue_type', 'description': 'Tissue type.'},
                            {'name': 'coordinates', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_position', 'description': 'Genomic coordinates.'},
                            {'name': 'trna_name', 'sqlite_type': 'TEXT', 'semantic_type': 'name', 'description': 'tRNA source name.'},
                            {'name': 'anticodon', 'sqlite_type': 'TEXT', 'semantic_type': 'sequence_feature', 'description': 'Anticodon sequence.'},
                            {'name': 'gsm', 'sqlite_type': 'TEXT', 'semantic_type': 'accession_id', 'description': 'GEO Sample ID.'},
                            {'name': 'pmid', 'sqlite_type': 'TEXT', 'semantic_type': 'publication_id', 'description': 'PubMed ID.'},
                            {'name': 'experiment', 'sqlite_type': 'TEXT', 'semantic_type': 'metadata', 'description': 'Experiment description.'},
                            {'name': 'sequence', 'sqlite_type': 'TEXT', 'semantic_type': 'biological_sequence', 'description': 'tRF sequence.'},
                            {'name': 'sequence_length', 'sqlite_type': 'TEXT', 'semantic_type': 'length_value', 'description': 'Sequence length (CAST to INTEGER).'},
                            {'name': 'query_frequency', 'sqlite_type': 'TEXT', 'semantic_type': 'frequency', 'description': 'Query frequency.'},
                            {'name': 'chr', 'sqlite_type': 'TEXT', 'semantic_type': 'chromosome', 'description': 'Chromosome.'},
                            {'name': 'sub_length', 'sqlite_type': 'TEXT', 'semantic_type': 'length_value', 'description': 'Subsequence length.'},
                            {'name': 'sub_info', 'sqlite_type': 'TEXT', 'semantic_type': 'metadata', 'description': 'Subsequence info.'},
                            {'name': 'molecule', 'sqlite_type': 'TEXT', 'semantic_type': 'molecule_type', 'description': 'Molecule type.'},
                            {'name': 'description', 'sqlite_type': 'TEXT', 'semantic_type': 'metadata', 'description': 'Additional description.'},
                            {'name': 'gsm_link', 'sqlite_type': 'TEXT', 'semantic_type': 'url', 'description': 'GEO sample link.'},
                            {'name': 'pmid_link', 'sqlite_type': 'TEXT', 'semantic_type': 'url', 'description': 'PubMed link.'},
                            {'name': 'seq_link', 'sqlite_type': 'TEXT', 'semantic_type': 'url', 'description': 'Sequence link.'}
                        ],
                        'description': 'tRNA-derived RNA Fragments (tRFs) with genomic coordinates and metadata.',
                        'primary_keys': ['ptrf_id'],
                        'common_joins': {
                            'PbtRF': "On `organism`, `tissue`, or `sequence`.",
                            'PtncRNAdb': "On `organism`, `tissue`, or `sequence`."
                        },
                        'notes': ["Focuses on tRF characteristics, not expression."]
                    },
                    'PbtRF': {
                        'columns': [
                            {'name': 'tRF_ID', 'sqlite_type': 'TEXT', 'semantic_type': 'primary_identifier', 'description': 'Unique tRF ID.'},
                            {'name': 'SRA_Accession', 'sqlite_type': 'TEXT', 'semantic_type': 'accession_id', 'description': 'Sequence Read Archive ID.'},
                            {'name': 'Organism', 'sqlite_type': 'TEXT', 'semantic_type': 'organism_name', 'description': 'Species name.'},
                            {'name': 'Tissue', 'sqlite_type': 'TEXT', 'semantic_type': 'tissue_type', 'description': 'Tissue type.'},
                            {'name': 'Development_stage', 'sqlite_type': 'TEXT', 'semantic_type': 'developmental_stage', 'description': 'Development stage.'},
                            {'name': 'tRF_type', 'sqlite_type': 'TEXT', 'semantic_type': 'category', 'description': 'tRF type (e.g., tRF-3).'},
                            {'name': 'Locus', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_position', 'description': 'Genomic locus.'},
                            {'name': 'Position', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_position', 'description': 'Position in genome.'},
                            {'name': 'Length', 'sqlite_type': 'TEXT', 'semantic_type': 'length_value', 'description': 'tRF length (CAST to INTEGER).'},
                            {'name': 'Stress', 'sqlite_type': 'TEXT', 'semantic_type': 'experimental_condition', 'description': 'Stress condition.'},
                            {'name': 'Sequence', 'sqlite_type': 'TEXT', 'semantic_type': 'biological_sequence', 'description': 'tRF sequence.'},
                            {'name': 'Expression', 'sqlite_type': 'TEXT', 'semantic_type': 'expression_value_raw', 'description': 'Raw expression (CAST to REAL or treat as categorical).'},
                            {'name': 'log2fold_change', 'sqlite_type': 'TEXT', 'semantic_type': 'expression_value_log2fc', 'description': 'Log2 fold change (CAST to REAL).'},
                            {'name': 'Modification', 'sqlite_type': 'TEXT', 'semantic_type': 'modification', 'description': 'Sequence modification.'}
                        ],
                        'description': 'tRF expression data across organisms and stress conditions.',
                        'primary_keys': ['tRF_ID'],
                        'common_joins': {
                            'PtRFdb': "On `Organism`, `Tissue`, or `Sequence`.",
                            'PtncRNAdb': "On `Organism`, `Tissue`, or `Sequence`."
                        },
                        'notes': ["Primary for tRF expression analysis. `Expression` can be numeric or categorical (e.g., 'Upregulated')."]
                    },
                    'PtncRNAdb': {
                        'columns': [
                            {'name': 'PTNCRNA', 'sqlite_type': 'TEXT', 'semantic_type': 'primary_identifier', 'description': 'Unique tncRNA ID.'},
                            {'name': 'organism', 'sqlite_type': 'TEXT', 'semantic_type': 'organism_name', 'description': 'Species name.'},
                            {'name': 'project', 'sqlite_type': 'TEXT', 'semantic_type': 'metadata', 'description': 'Project ID.'},
                            {'name': 'run', 'sqlite_type': 'TEXT', 'semantic_type': 'accession_id', 'description': 'Run ID.'},
                            {'name': 'srp', 'sqlite_type': 'TEXT', 'semantic_type': 'accession_id', 'description': 'Study ID.'},
                            {'name': 'gsm', 'sqlite_type': 'TEXT', 'semantic_type': 'accession_id', 'description': 'GEO Sample ID.'},
                            {'name': 'tissue', 'sqlite_type': 'TEXT', 'semantic_type': 'tissue_type', 'description': 'Tissue type.'},
                            {'name': 'condition_stress', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_general', 'description': 'General stress condition.'},
                            # ... (other PtncRNAdb columns as before) ...
                            {'name': 'dev_stage', 'sqlite_type': 'TEXT', 'semantic_type': 'developmental_stage', 'description': 'Development stage.'},
                            {'name': 'tncRNA_Type', 'sqlite_type': 'TEXT', 'semantic_type': 'category', 'description': 'Type of tncRNA (e.g., tRF-5).'},
                            {'name': 'tRNA_info', 'sqlite_type': 'TEXT', 'semantic_type': 'metadata', 'description': 'tRNA source info.'},
                            {'name': 'position', 'sqlite_type': 'TEXT', 'semantic_type': 'genomic_position', 'description': 'Genomic position.'},
                            {'name': 'strand', 'sqlite_type': 'TEXT', 'semantic_type': 'strand', 'description': 'Genomic strand.'},
                            {'name': 'sequence', 'sqlite_type': 'TEXT', 'semantic_type': 'biological_sequence', 'description': 'tncRNA sequence.'},
                            {'name': 'length', 'sqlite_type': 'TEXT', 'semantic_type': 'length_value', 'description': 'Sequence length (CAST to INTEGER).'},
                            {'name': 'read_count', 'sqlite_type': 'TEXT', 'semantic_type': 'count', 'description': 'Read count (CAST to INTEGER).'},
                            {'name': 'rpm', 'sqlite_type': 'TEXT', 'semantic_type': 'expression_value', 'description': 'Reads Per Million (CAST to REAL).'},
                            {'name': 'modification', 'sqlite_type': 'TEXT', 'semantic_type': 'modification', 'description': 'Sequence modification.'},
                            {'name': 'target_no', 'sqlite_type': 'TEXT', 'semantic_type': 'count', 'description': 'Number of targets.'},
                            {'name': 'deg_organism', 'sqlite_type': 'TEXT', 'semantic_type': 'organism_name', 'description': 'Name of degraded organism.'},
                            {'name': 'deg_tncRNA_Type', 'sqlite_type': 'TEXT', 'semantic_type': 'category', 'description': 'Degraded tncRNA type.'},
                            {'name': 'aa', 'sqlite_type': 'TEXT', 'semantic_type': 'sequence_feature', 'description': 'Amino acid info.'},
                            {'name': 'deg_length', 'sqlite_type': 'TEXT', 'semantic_type': 'length_value', 'description': 'Degraded sequence length.'},
                            {'name': 'deg_sequence', 'sqlite_type': 'TEXT', 'semantic_type': 'biological_sequence', 'description': 'Degraded sequence.'},
                            {'name': '05_heat', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Heat condition at 0.5h.'},
                            {'name': '6h_heat', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Heat condition at 6h.'},
                            {'name': '20FC_drought', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': '20-fold change drought.'},
                            {'name': '30_FC_drought', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': '30-fold change drought.'},
                            {'name': 'Sulphur_deficiency', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Sulphur deficiency.'},
                            {'name': 'Cadmium_excess', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Cadmium excess.'},
                            {'name': 'Copper_deficiency', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Copper deficiency.'},
                            {'name': 'Copper_excess', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Copper excess.'},
                            {'name': 'NaCl_excess', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'NaCl excess.'},
                            {'name': 'Alternaria', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Alternaria infection.'},
                            {'name': 'RA_inoculated', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'RA inoculation.'},
                            {'name': 'tmv', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Tobacco mosaic virus.'},
                            {'name': 'leaf30', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Leaf at 30min.'},
                            {'name': 'leaf120', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Leaf at 120min.'},
                            {'name': 'root30', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Root at 30min.'},
                            {'name': 'root120', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Root at 120min.'},
                            {'name': 'znroot', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Zinc in root.'},
                            {'name': 'znshoot', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Zinc in shoot.'},
                            {'name': 'drought', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Drought condition.'},
                            {'name': 'salt', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Salt stress.'},
                            {'name': 'drought_salt', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Combined drought and salt.'},
                            {'name': 'rep_ear48h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Ear at 48h.'},
                            {'name': 'rep_leaf2h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Leaf at 2h.'},
                            {'name': 'rep_leaf48h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Leaf at 48h.'},
                            {'name': 'rep_silk2h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Silk at 2h.'},
                            {'name': 'rep_silk48h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Silk at 48h.'},
                            {'name': 'rep_tassel2h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Tassel at 2h.'},
                            {'name': 'rep_tassel48h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Tassel at 48h.'},
                            {'name': 'veg_leaf2h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Vegetative leaf at 2h.'},
                            {'name': 'veg_leaf48h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Vegetative leaf at 48h.'},
                            {'name': 'veg_root2h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Vegetative root at 2h.'},
                            {'name': 'veg_root48h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Vegetative root at 48h.'},
                            {'name': 'veg_stalk2h', 'sqlite_type': 'TEXT', 'semantic_type': 'condition_specific_flag', 'description': 'Vegetative stalk at 2h.'},
                            {'name': 'deg_tissue', 'sqlite_type': 'TEXT', 'semantic_type': 'tissue_type', 'description': 'Degraded tissue type.'}
                        ],
                        'description': 'tRNA-derived non-coding RNA data with expression and condition-specific flags.',
                        'primary_keys': ['PTNCRNA'],
                        'common_joins': {
                            'PbtRF': "On `organism`, `tissue`, or `sequence`.",
                            'PtRFdb': "On `organism`, `tissue`, or `sequence`."
                        },
                        'notes': ["Includes tRFs and other tncRNAs. Use `condition_stress` for general stress or specific flag columns."]
                    },
                }
            }
        }
        # Initialize species and tissues for all tables, including the new one
        self.species = {table_name: set() for table_name in self.schema['trf.db']['tables']}
        self.tissues = {table_name: set() for table_name in self.schema['trf.db']['tables']}
    ...
    def _enrich_schema_with_dynamic_info(self): # No changes needed here, it's generic
        try:
            ...
            cursor = conn.cursor()
            for table_name, table_data in self.schema['trf.db']['tables'].items():
    ...
    def update_schema_from_db(self): # Modified to handle new table's species column
        try:
            conn = sqlite3.connect(f"file:{self.db_path}?mode=ro", uri=True)
            cursor = conn.cursor()
            for table_name in self.schema['trf.db']['tables']:
                self.species.setdefault(table_name, set())
                self.tissues.setdefault(table_name, set())
                table_columns = {col['name'] for col in self.schema['trf.db']['tables'][table_name]['columns']}
    ...
    def get_tables(self) -> List[str]: # No changes needed here
        return list(self.schema['trf.db']['tables'].keys())
...
**Database Summaries:**
*   **PbtRF Database (PbtRF):** Focus on plant tRFs under **biotic stress** (Arabidopsis, Oryza sativa, Solanum lycopersicum). Key data: tRF `Sequence`, `tRF_type`, `Expression` (categorical/numeric `log2fold_change`), `Organism`, `Tissue`, `Stress`. Do not contain any abiotic stress related data.
*   **PtncRNA Database (PtncRNAdb):** Comprehensive tncRNAs (includes tRFs) from 6 plant species (Arabidopsis, Cicer, Zea mays, etc.). Key data: tncRNA `sequence`, `tncRNA_Type`, `organism`, `tissue`, `condition_stress`, expression (`rpm`, `read_count`).
*   **PtRF Database (PtRFdb):** Plant tRFs (tRF-5, tRF-3, tRF-1) from 10 plant species. Key data: tRF `sequence`, `trf_type`, `organism`, `tissue`, coordinates. Primarily for tRF characterization.
*   **AtFusionDB (AtFusionDB):** **Arabidopsis thaliana ONLY** fusion transcripts. Key data: `gene1`, `gene2`, `junction_sequence`, `tissue`.
...
*** You are only speciealised chatbot for answering trf related querries and cater the following databases on trfs and tncRNAs that are PbtRF Database, PtncRNAdb and
PtRFdb. ***
...
1.  "METADATA_DIRECT_ANSWER_PREFERRED": The query asks for general knowledge or facts ABOUT the databases(eg: 'where can i get biotic stress related data"/ "abiotic stress related data can be found where" etc.) or the concepts they contain. This includes questions of existence like "What is PbtRF?", "What are tRFs?", "Do you have data on abiotic stress?", or "What kind of data is in CoNCRAtlasdb?". These should be answered from a knowledge base.
2.  "METADATA_SQL_FALLBACK_PREFERRED": Query asks for metadata *about the data within the databases* that might require a simple SQL query if not directly in a knowledge text, but still benefits from the knowledge text for context (e.g., "how many species are in PbtRF?", "list tissue types in AtFusionDB?", "what peptide functions are listed in plantpepdb?").
3.  "DATA_RETRIEVAL": ***Any Query starting with ("what is the the", "which","fetch","tell me about","what can be", "give me" etc.)***, Query asks to find specific data records, perform calculations on data, or compare data sets *within the described scope of the databases* (e.g., "find genes in Arabidopsis involved in fusions", "list tRFs with expression > 2 in PbtRF").**Crucially, this also includes vague follow-up commands (like 'ok do it', 'show me', 'run that', 'yes please') that directly relate to a data action proposed or described by the bot in the `conversation_summary`.** Use the context to see if the user is confirming a previous action.
...
- **PbtRF Expression:** `PbtRF.Expression` is categorical. For numeric expression comparison/aggregation in PbtRF, use `PbtRF.log2fold_change` (REAL).
- **Species/Tissue Columns:** These vary per table. Consult `schemas_json` or specific column mappings in `knowledge_graph`.
    ...
    - Example Tissue Columns (refer to KG/schemas for authoritative list): PbtRF.Tissue, PFusionDB.Tissue, PtRFdb.tissue, PtncRNAdb.tissue (and deg_tissue), AtFusionDB.tissue. (CoNCRAtlasdb and plantpepdb generally do not have a standard 'tissue' column for broad searches).
- **Tissue Name Searching:** Tissue names in the DBs are often Title Cased with spaces (e.g., 'Rosette Leaf', 'Root'). Use `LIKE '%keyword%'` for tissue searches (e.g., `tissue LIKE '%leaf%'`) for flexibility.
- **PbtRF Expression:** `PbtRF.Expression` is categorical. For numeric comparisons, use `PbtRF.log2fold_change` (REAL).
- **AtFusionDB is ONLY Arabidopsis:** This table has NO 'species' column. Do not add a `WHERE` clause for species.
...
2.  **Database Targeting Strategy (Guided by `knowledge_graph` and above CRITICAL RULES):**
    *   **Default Grouping (if no specific DB named by user):** Use groupings specified in `knowledge_graph`.
        *   Example: "tRFs"/"tncRNAs" -> PbtRF, PtRFdb, AND PtncRNAdb.
        *   Example: "fusions" -> AtFusionDB (implicitly Arabidopsis) AND PFusionDB.
    *   **Species Name Reasoning:** Use hints from `knowledge_graph` (e.g., "rice" -> `LIKE 'Oryza sativa%'`, "cotton" -> `LIKE 'Gossypium%'`). For "Arabidopsis", target AtFusionDB (no species filter needed) and PFusionDB (with `WHERE <species_column_from_schema> LIKE 'Arabidopsis thaliana%'` for PFusionDB).
...
**IF the user's query EXPLICITLY uses comparison words like 'common', 'shared', 'intersection', 'both', 'compare', 'vs', 'versus' AND mentions multiple databases or a database group:**
  * This is the ONLY time you should generate an INTERSECT query.
   `analysis_plan`: "Finding common '{{item_type}}' across the specified TRF databases."
   `purpose_type`: `data_preview_trf_intersection`
    CRITICAL: You MUST identify the specific databases mentioned by the user.
    CRITICAL: You MUST generate a SINGLE query object using `INTERSECT`. This query MUST alias the heterogeneous column names to a single, common name.
    Column Mapping for TRF DBs:
   - **Species:** `PbtRF` uses `"Organism"`, while `PtRFdb` and `PtncRNAdb` use `"organism"`.
   - **Tissue:** `PbtRF` uses `"Tissue"`, while `PtRFdb` and `PtncRNAdb` use `"tissue"`.

   Example for "what species are common between pbtrf and ptrfdb?":#   {{
     "sql": "SELECT DISTINCT TRIM(LOWER(\\"Organism\\")) AS common_species FROM \\"PbtRF\\" INTERSECT SELECT DISTINCT TRIM(LOWER(\\"organism\\")) FROM \\"PtRFdb\\";",
     "target_table": "PbtRF, PtRFdb",
     "database_conceptual_name": "PbtRF & PtRFdb",
     "description": "Finds the common species present in both PbtRF and PtRFdb.",
     "purpose_type": "data_preview_trf_intersection",
     "display_columns_hint": ["common_species"]
   }}

   Example for "what tissues are common between all trf databases?":
   {{
     "sql": "SELECT DISTINCT TRIM(LOWER(\\"Tissue\\")) AS common_tissue FROM \\"PbtRF\\" INTERSECT SELECT DISTINCT TRIM(LOWER(\\"tissue\\")) FROM \\"PtRFdb\\" INTERSECT SELECT DISTINCT TRIM(LOWER(\\"tissue\\")) FROM \\"PtncRNAdb\\";",
     "target_table": "PbtRF, PtRFdb, PtncRNAdb",
     "database_conceptual_name": "PbtRF, PtRFdb, & PtncRNAdb",
     "description": "Finds the common tissues present in all three TRF databases.",
     "purpose_type": "data_preview_trf_intersection",
...
5.  **Handling General Concepts vs. Specific Columns (Abiotic/Biotic Stress Example):**
    - The `PbtRF` database contains **only biotic stress** data in the `"Stress"` column.
    - The `PtncRNAdb` database contains abiotic stress data scattered across **multiple columns**. If the user asks for "abiotic stress", "drought", "heat", "salt", etc., you MUST create a query that checks all potentially relevant columns with `OR`.
    - **Example for 'heat stress' in `PtncRNAdb`:** `SELECT * FROM "PtncRNAdb" WHERE "condition_stress" LIKE '%heat%' OR "05_heat" = '1' OR "6h_heat" = '1';`
    - **Example for general 'abiotic stress' in `PtncRNAdb`:** `SELECT * FROM "PtncRNAdb" WHERE "condition_stress" LIKE '%abiotic%' OR "drought" = '1' OR "salt" = '1' OR "05_heat" = '1' OR "6h_heat" = '1' OR "Cadmium_excess" = '1' OR "NaCl_excess" = '1';`
...
11. **CRITICAL: Handling Complex, Distributed Concepts:**
    - The Knowledge Graph provides mappings for concepts like "abiotic stress" that are spread across multiple columns in a single database (`PtncRNAdb`).
    - If the user asks for such a concept, you **MUST** consult the Knowledge Graph to identify the correct database and all relevant columns.
    - You **MUST** then generate a single SQL query that combines checks on all these columns using the `OR` operator.
    - **Example for a general query like "what abiotic stress data do you have?":**
      Your plan should identify that `PtncRNAdb` is the sole source. The SQL WHERE clause must be comprehensive, checking the general description column AND all relevant flag columns. It should look like this:
      `sql`: "SELECT * FROM \\"PtncRNAdb\\" WHERE LOWER(\\"condition_stress\\") LIKE '%abiotic%' OR LOWER(\\"condition_stress\\") LIKE '%drought%' OR LOWER(\\"condition_stress\\") LIKE '%heat%' OR LOWER(\\"condition_stress\\") LIKE '%salt%' OR \\"drought\\" = '1' OR \\"salt\\" = '1' OR \\"05_heat\\" = '1' OR \\"6h_heat\\" = '1' OR \\"NaCl_excess\\" = '1' OR \\"Cadmium_excess\\" = '1' OR \\"Sulphur_deficiency\\" = '1' OR \\"Copper_deficiency\\" = '1' OR \\"Copper_excess\\" = '1';"
...
*** You are only speciealised chatbot for answering trf related querries and cater the following databases on trfs and tncRNAs that are PbtRF Database, PFusionDB or Plant Fusion Database and
PtRFdb. ***
...
8.  **TASK: HANDLING DISTINCT LISTS (e.g., "what species in pbtrfdb"):**
...
def process_query(query: str, conversation_id: Optional[str] = None, model_name: str = 'gpt-oss-120b', user_api_key: Optional[str] = None) -> Dict:
    ...
    if classified_intent == "OUT_OF_SCOPE":
        ...
        summary_text = "I specialize in plant genomics data related to tRFs & tncRNAs. I'm unable to answer questions outside this domain, such as about general knowledge, current events, or other types of biological molecules like siRNAs."
        if conversation_id:
    ...
    if classified_intent == "GENERAL_CONVERSATION":
        ...
        bot_response = "Hello! How can I help you with plant tRF & tncRNA data today?"
...
- Tables & Primary Use (Conceptual Names from DATABASE_MAPPING):
  - {DATABASE_MAPPING.get("PbtRF", "PbtRF")}: tRF expression (biotic stress). Species col: `Organism`. tRF type col: `tRF_type`. Expression: `Expression` (categorical), `log2fold_change` (numeric).
  - {DATABASE_MAPPING.get("PtRFdb", "PtRFdb")}: tRF sequences/types. Species col: `organism`. tRF type col: `trf_type`.
  - {DATABASE_MAPPING.get("PtncRNAdb", "PtncRNAdb")}: tncRNAs (incl. tRFs), expression. Species col: `organism`. tRF type col: `tncRNA_Type`. Expression: `rpm` (numeric).
  - **{DATABASE_MAPPING.get("AtFusionDB", "AtFusionDB")}: Arabidopsis thaliana fusions ONLY. CRITICAL: This table has NO general 'species' or 'organism' column; its Arabidopsis context is implicit. Do not use WHERE species/organism clauses for this table.** Tissue col: `tissue`.
  - {DATABASE_MAPPING.get("PFusionDB", "PFusionDB")}: Plant fusion transcripts (multiple species). Species col: `species`. Tissue col: `Tissue`.

- **Handling of Complex Concepts:**
  - **Biotic Stress:** Found primarily in the `PbtRF.Stress` column.
  - **Abiotic Stress:** This concept is found ONLY in `PtncRNAdb` and is distributed across multiple columns. You must build a query that checks columns related to the user's specific query. Use the following semantic map to link user concepts to database columns:
    - **General Concept ('abiotic stress'):** For a broad query, use `LOWER("condition_stress") LIKE '%abiotic%'` AND combine it with checks on specific flag columns below using OR.
    - **[Concept: Heat Stress]:** `LOWER("condition_stress") LIKE '%heat%'` OR `"05_heat"` = '1' OR `"6h_heat"` = '1'.
    - **[Concept: Drought Stress]:** `LOWER("condition_stress") LIKE '%drought%'` OR `"drought"` = '1' OR `"20FC_drought"` = '1' OR `"30_FC_drought"` = '1'.
    - **[Concept: Salt Stress]:** `LOWER("condition_stress") LIKE '%salt%'` OR `"salt"` = '1' OR `"NaCl_excess"` = '1'.
    - **[Concept: Metal/Ion Stress]:** `LOWER("condition_stress") LIKE '%metal%'` OR `LOWER("condition_stress") LIKE '%ion%'` OR `LOWER("condition_stress") LIKE '%zinc%'` OR `LOWER("condition_stress") LIKE '%cadmium%'` OR `LOWER("condition_stress") LIKE '%copper%'` OR `"znroot"` = '1' OR `"znshoot"` = '1' OR `"Cadmium_excess"` = '1' OR `"Copper_deficiency"` = '1' OR `"Copper_excess"` = '1'.
    - **[Concept: Nutrient Deficiency]:** `LOWER("condition_stress") LIKE '%deficiency%'` OR `"Sulphur_deficiency"` = '1' OR `"Copper_deficiency"` = '1'.
